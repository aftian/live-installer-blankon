...
gettext.install("live-installer", "/usr/share/blankon/locale")
...
class InstallerWindow:
    ...
    def __init__(self, fullscreen=False):
        ...
        self.wizard_pages[self.PAGE_INSTALL] = WizardPage(_("Installing BlankOn..."), "install.png")
    ...
    def face_select_picture_button_clicked(self, widget, event):
        ...
        if os.path.exists("/home/blankon"):
            chooser.add_shortcut_folder("/home/blankon")
    ...
    def i18n(self):
        ...
        # hdd page
        self.wTree.get_widget("label_radio_hdd").set_label(_("Install Linux BlankOn on the selected drive:"))
    ...
    def build_lang_list(self):
        ...
        try:
            whatismyip = 'http://www.blankonlinux.or.id'
    ...
    def assign_language(self, treeview, data=None):
        ...
        self.setup.print_setup()
        try:            
            self.translation = gettext.translation('live-installer', "/usr/share/blankon/locale", languages=[self.setup.language])
            self.translation.install()
        except Exception, detail:
            print "No translation found, switching back to English"
            self.translation = gettext.translation('live-installer', "/usr/share/blankon/locale", languages=['en'])
            self.translation.install()        
        try:
            self.i18n()
        except:
